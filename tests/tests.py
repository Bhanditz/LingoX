...
class DefaultLocaleMiddlewareTest(TestCase):
    ...
    def test_is_enabled_method(self, data):
        ...
        with override_settings(**overrides):
            assert self.middleware.is_feature_enabled() == data['expected'], data['message']
    ...
    def test_feature_flags(self, data):
        ...
        """
        with patch(
            target='lingox.middleware.DefaultLocaleMiddleware.is_feature_enabled',
            return_value=data['is_feature_enabled'],
        ):
            assert self.middleware.is_feature_enabled() == data['is_feature_enabled']
